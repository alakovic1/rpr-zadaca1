...
public class King extends ChessPiece {
    ...
    public void move(String position) throws IllegalArgumentException/*, IllegalChessMoveException*/{
        ...
        if((this.position.charAt(0)-position.charAt(0))!=1 || (this.position.charAt(0)-position.charAt(0))!=-1) {} /*throw new IllegalChessMoveException();*/
        else if((this.position.charAt(0)==position.charAt(0)) || (this.position.charAt(0)-position.charAt(0))==1 || (this.position.charAt(0)-position.charAt(0))==-1){
            if((this.position.charAt(1)-position.charAt(1))!=1 || (this.position.charAt(1)-position.charAt(1))!=-1){} /*throw new IllegalChessMoveException();*/
        }
